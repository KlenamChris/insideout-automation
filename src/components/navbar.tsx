...
const NAV_LINKS = [
   { href: "/", label: "Home" },
   { href: "/smart-homes", label: "Smart Living" },
   { href: "/3d-services", label: "3D Tour" },
         ...
         <div className="container mx-auto px-4 md:px-6">
            <div className="flex items-center justify-between">
               ...
               <Link href="/" className="flex items-center gap-2 z-50 relative" aria-label="Home">
                  <Image src="/images/logo.png" alt="Insideout Automation" width={40} height={40} />
                  <h1 className="font-extrabold text-xl text-brand-evergreen hidden sm:block">Insideout Automation</h1>
               </Link>
